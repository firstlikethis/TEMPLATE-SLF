...
<body class="hold-transition sidebar-mini layout-fixed">
    ...
    <%
        ...
        if(inFlag.equals("INSERT")){
            try{
				...
				sql=" insert into slf_sso.munusys(menuid,menuname,appname,logo_menu,active_flag,seq_no) values('"+menuid+"','"+menuname+"' ,'"+appname+"', '"+logo_menu+"', '"+active_flag+"', "+seq_no+") ";
                //out.print(sql);
    ...
    <%
        if(upFlag.equals("UPDATE")){
            try{
                sql3=" update slf_sso.munusys set menuname='"+menuname+"', logo_menu='"+logo_menu+"' ,seq_no="+seq_no+" , active_flag='"+active_flag+"' where menuid='"+aID2+"' ";
                //out.print(sql3);
                                ...
                                <div class="card-body">
                                    ...
                                    <input type="hidden" name="openModal" id="openModal">
                                        <table class="table table-bordered" id="example">
                                            ...
                                            <tbody>
                                        <%
                                            sql2 = " select MENUID, MENUNAME, nvl(APPNAME, '-') as APPNAME, LOGO_MENU, SEQ_NO, ACTIVE_FLAG from slf_sso.munusys order by menuid ";
