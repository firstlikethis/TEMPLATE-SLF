                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            %>
                                                                    <option value="<%= Tools.chkNull(rsMenu.getString("menuid")) %>">
                                                                        <%
                                                                            if (Tools.chkNull(rsMenu.getString("appname")).equals("")) {
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            %>
                                                                    ...
                                                                    <%
                                                                        if (Tools.chkNull(rsFile.getString("appname")).equals("")) {
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <% 
                                                                try {
                                                                    ...
                                                                    sql2 = "select distinct a.menuid, a.menuname, a.seq_no, a.active_flag, nvl(a.APPNAME, '-') as APPNAME " +
