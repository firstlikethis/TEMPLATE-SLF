...
<body class="hold-transition sidebar-mini layout-fixed">
    ...
    <%
        ...
        if(inFlag.equals("INSERT")){
            try{
				...
				sql=" insert into slf_sso.programsys(proid,proname,filename,appid,menuid,procode,active_flag,seq_no,promain) values('"+proid+"','"+proname+"', '"+filename+"' ,'"+appname+"', '"+menuname+"', '"+procode+"', '"+active_flag+"', "+seq_no+",'"+promain+"') ";
                //out.print(sql);
                        ...
                        <form method="post" id="formUPmodal">
                            ...
                            <%
                                ...
                                if(rs4.next()){
                                    ...
                                    String mpid = Tools.chkNull(rs4.getString("menuid"));
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select id="menuname" name="menuname" class="form-control">
                                                    ...
                                                    <%
                                                        ...
                                                        if (!mpid.equals("")) {
                                                            tempSQL2 = "1=1 OR A.MENUID = '"+mpid+"'";
                                                        } else {
                                                            tempSQL2 = "1=1"; 
                                                        }
                                                        
                                                        String sqMenu = "SELECT A.MENUID, A.MENUNAME, A.APPID, B.APPNAME " +
                                                                        "FROM SLF_SSO.munusys A " +
                                                                        "LEFT JOIN SLF_SSO.APPSYS B ON A.APPID = B.APPID " +
                                                                        "WHERE A.ACTIVE_FLAG = 'Y' AND (" + tempSQL2 + ")";
                                                        ...
                                                        while(rsMenu.next()) {
                                                            String currentMenuId = Tools.chkNull(rsMenu.getString("menuid"));
                                                    %>
                                                            <option value="<%= currentMenuId %>" <%= (mpid.equals(currentMenuId) ? "selected" : "") %>>
                                                                โปรแกรม : <%= Tools.chkNull(rsMenu.getString("APPNAME")) %> | เมนู : <%= Tools.chkNull(rsMenu.getString("MENUNAME")) %>
                                                            </option>
                                                    <%
                                                        }
                                                        stMenu.close();
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select id="promain" name="promain" class="form-control">
                                                    ...
                                                    <option value="Y" <% if (pm.equals("Y")) { %>selected<% } %>>หน้าแรก</option>
                                                    <option value="N" <% if (pm.equals("N")) { %>selected<% } %>>หน้ารอง</option>
                                                </select>
                                            </div>
                                        </div>
    ...
    <%
        if(upFlag.equals("UPDATE")){
            try{
                sql3=" update slf_sso.programsys set proname='"+proname+"', filename='"+filename+"' ,procode='"+procode+"' , appid='"+appname+"', menuid='"+menuname+"', seq_no = '"+seq_no+"' , active_flag='"+active_flag+"', promain='"+promain+"' where proid='"+aID2+"' ";
                //out.print(sql3);
                ...
                <div class="container-fluid">
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            ...
                            <li class="breadcrumb-item active">เพิ่มไฟล์โปรแกรม</li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
                                    ...
                                    <form action="" method="post" id="formInsert">
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" id="proid" name="proid" placeholder="รหัสไฟล์" class="form-control" oninput="lockInput(this, 5);">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label for="proname">File Menu Name:</label>
                                                    <input type="text" id="proname" name="proname" placeholder="ชื่อเมนูไฟล์" class="form-control" oninput="lockInput(this, 50);">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label for="filename">Path:</label>
                                                    <input type="text" id="filename" name="filename" placeholder="เส้นทางของไฟล์" class="form-control" oninput="lockInput(this, 50);">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select id="menuname" name="menuname" class="form-control">
                                                        ...
                                                        <%
                                                            ...
                                                            while(rsMenu.next()){
                                                        %>
                                                            <option value="<%=Tools.chkNull(rsMenu.getString("menuid"))%>">โปรแกรม : <%=Tools.chkNull(rsMenu.getString("APPNAME"))%> | เมนู : <%=Tools.chkNull(rsMenu.getString("MENUNAME")) %></option>
                                                        <%
                                                            }stMenu.close();
                                                            rsMenu.close();
                                                        %>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label for="procode">File Code:</label>
                                                    <input type="text" id="procode" name="procode" placeholder="โค้ดไฟล์" class="form-control" oninput="lockInput(this, 10);">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <select id="promain" name="promain" class="form-control">
                                                        <option value="">เลือกหน้า</option>
                                                        <option value="Y">หน้าแรก</option>
                                                        <option value="N">หน้ารอง</option>
                                                    </select>
                                                </div>
                                            </div>
                                ...
                                <div class="card-body">
                                    <form action="" method="post" id="formUpdate">
                                        ...
                                        <table class="table table-bordered" id="example">
                                            ...
                                            <tbody>
                                        <%
                                            /**sql2 = " select proid, proname,nvl(promain,'-') as promain, filename, nvl(appid,'-') as appid, nvl(menuid,'-') as menuid, procode, SEQ_NO, ACTIVE_FLAG "+
                                                   " from slf_sso.programsys order by proid "; **/
                                                sql2 = " SELECT DISTINCT A.PROID , A.PRONAME, NVL(A.PROMAIN , '-') AS PROMAIN , A.FILENAME , NVL(B.APPNAME, '-') AS APPNAME "+
                                                       ",NVL(C.MENUNAME , '-') AS MENUNAME , A.PROCODE, A.SEQ_NO, A.ACTIVE_FLAG "+
                                                       " FROM slf_sso.programsys A "+
                                                       " LEFT JOIN SLF_SSO.APPSYS B ON A.APPID = B.APPID "+
                                                       " LEFT JOIN SLF_SSO.MUNUSYS C ON A.MENUID = C.MENUID "+
                                                       " ORDER BY A.PROID ";
