...
public class DBUtil {
    ...
    public static String call_service = PccProperties.getResourceString("CALL_SERVICE");

    public static String  schemaICL55_MASTER = PccProperties.getResourceString("SCHEMA_ICL55_MASTER");
    public static String  schemaICL55 = PccProperties.getResourceString("SCHEMA_ICL55");
